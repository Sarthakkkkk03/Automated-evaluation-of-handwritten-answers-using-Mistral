...
# Page config
st.set_page_config(page_title="Handwritten answer evaluator", layout="wide")
...
st.markdown("""
    ...
    <div class="title">Handwritten Answer Evaluator</div>
    <div class="subtitle">Select your role to continue</div>
""", unsafe_allow_html=True)

# URLs
teacher_url = 'https://automated-evaluation-of-handwritten-answers-using-mistral-nddm.streamlit.app/'
student_url = 'https://automated-evaluation-of-handwritten-answers-using-mistral-86qm.streamlit.app/'
...
with col1:
    st.markdown(f"""
        <div class="role-box">
            ...
            <h3>👩‍🏫 I'm a Teacher</h3>
            <p>Examine and asses handwritten answers by leveraging the power of GenAI</p>
...
with col2:
    st.markdown(f"""
        <div class="role-box">
            ...
            <h3>🎓 I'm a Student</h3>
            <p>Check the scores of attempted tests and obtain visuals on it.</p>
